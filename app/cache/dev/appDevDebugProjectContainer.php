...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\MiAppBundle\\Entity'))), 'MiAppBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('MiAppBundle' => 'MiAppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7e43a3ea6802adf73469db77f6d6fe9111c3bfb473755cdd2719aa8438236ba3');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MiAppBundle\\Entity\\FosUser');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('admin@proyect.iaw.com.ar' => 'comision01.com'), 'resetting' => array('admin@proyect.iaw.com.ar' => 'comision01.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MiAppBundle\\Entity\\FosUser');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MiAppBundle\\Entity\\FosUser');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MiAppBundle\\Entity\\FosUser');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'MiAppBundle\\Entity\\FosUser');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/jugadores/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/goles/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/equipos/');
        ...
        $o->add($k, array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MiAppBundle/Resources/views'), 'MiApp');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b888d31454c57f94cf8df2adb6643d5e719daf64');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MiAppBundle' => 'MiAppBundle\\MiAppBundle',
            ...
            'secret' => 'b888d31454c57f94cf8df2adb6643d5e719daf64',
            'locale' => 'en',
            ...
            'kernel.secret' => 'b888d31454c57f94cf8df2adb6643d5e719daf64',
            ...
            'fos_user.model.user.class' => 'MiAppBundle\\Entity\\FosUser',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'admin@proyect.iaw.com.ar' => 'comision01.com',
            ),
